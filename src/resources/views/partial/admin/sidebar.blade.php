                    ...
                    @canany(['users_access','roles_access','permissions_access'])
                        <li class="sidebar-item">
                            ...
                            ">
                                ...
                                @can('permissions_access')
                                <li class="sidebar-item">
                                    <a class="sidebar-link waves-effect waves-dark  @if(request()->is('admin/permission_classfications') || request()->is('admin/permission_classfications/*')) is_active @endif" href="{{ route('admin.permission_classfications.index') }}" aria-expanded="false">
                                        <i class="mr-3 mdi mdi-star" aria-hidden="false"></i>
                                        <span class="hide-menu">Classifications</span>
                                    </a>
                                </li>
                                @endcan
                            </ul>
